...
(function ($) {
  ...
  var DEFAULT_CATALOG = [
    { slot: 'session_1', label: 'Friday 4:00–5:00 PM', picks: 2, seminars: [
      ...
      { title: 'Refined by Fire, Revealed in Beauty', speaker: 'Rita Tasche', description: "Learn how hard seasons shape strength, depth, and resilience — how to walk through trials without losing our faith, and how to find purpose in pain while developing a strength that comes only through surrender to God." }
    ] },
