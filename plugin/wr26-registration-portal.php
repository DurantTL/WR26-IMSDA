...
function attendeeHtml(a,i){const prefs=a.seminar_preferences||{};function pref(slot,key){return esc((prefs[slot]&&prefs[slot][key])||"");}return `<div class="wr26p-attendee" data-i="${i}"><h4>Attendee ${i+1}</h4><div class="wr26p-grid"><label>First Name<br><input data-a="first_name" value="${esc(a.first_name)}"></label><label>Last Name<br><input data-a="last_name" value="${esc(a.last_name)}"></label><label>Phone<br><input data-a="phone" value="${esc(a.phone)}"></label><label>Email<br><input data-a="email" value="${esc(a.email)}"></label><label>Church<br><input data-a="church" value="${esc(a.church)}"></label><label>Adult/Child<br><input data-a="attendee_type" value="${esc(a.attendee_type)}"></label><label>Meal Preference<br><input data-a="meal_preference" value="${esc(a.meal_preference)}"></label><label>Childcare Needed<br><input data-a="childcare_needed" value="${esc(a.childcare_needed)}"></label><label>Dietary Needs<br><textarea data-a="dietary_needs" rows="2">${esc(a.dietary_needs)}</textarea></label><label>Notes<br><textarea data-a="notes" rows="2">${esc(a.notes)}</textarea></label></div><h5>Seminar Preferences</h5><div class="wr26p-grid"><label>Friday 4 PM Pref 1<br><input data-pref="session_1.pref_1" value="${pref("session_1","pref_1")}"></label><label>Friday 4 PM Pref 2<br><input data-pref="session_1.pref_2" value="${pref("session_1","pref_2")}"></label><label>Sat 2 PM Pref 1<br><input data-pref="session_2.pref_1" value="${pref("session_2","pref_1")}"></label><label>Sat 2 PM Pref 2<br><input data-pref="session_2.pref_2" value="${pref("session_2","pref_2")}"></label><label>Sat 3:30 Pref 1<br><input data-pref="session_3.pref_1" value="${pref("session_3","pref_1")}"></label><label>Sat 3:30 Pref 2<br><input data-pref="session_3.pref_2" value="${pref("session_3","pref_2")}"></label><label>Sunday 8:15<br><input data-pref="session_4.pref_1" value="${pref("session_4","pref_1")}"></label></div><input type="hidden" data-a="attendee_id" value="${esc(a.attendee_id)}"></div>`;}
