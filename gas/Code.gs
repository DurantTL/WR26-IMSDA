...
function doPost(e){
  try{
    ...
    var publicPortalAllowed={portalRequestMagicLink:true,portalGetRegistrationByMagicToken:true,portalSaveRegistrationByMagicToken:true};
